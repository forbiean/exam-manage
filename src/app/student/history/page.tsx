...
import { BookOpen, Clock, FileText, Award, AlertCircle, CheckCircle2, HelpCircle } from "lucide-react";

function getStatusBadge(status: string) {
  switch (status) {
    case "reviewed":
      return <Badge variant="default" className="bg-emerald-600 hover:bg-emerald-700">已出分</Badge>;
    case "submitted":
